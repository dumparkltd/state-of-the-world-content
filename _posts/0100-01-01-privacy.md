...
Our privacy policy (preliminary)

# Contact information

## Website Owner and Data Controller

Universal Rights Group, Geneva <br>
Maison de la Paix <br>
Chemin Eugène-Rigot 2E, Building 5 <br>
CH-1202 Geneva <br>
Switzerland <br>

Owner contact email: [secretariat@universal-rights.org](mailto:secretariat@universal-rights.org)
...
We use Google Firebase to host our website and GitHub Pages for our content and data.

#### Google Firebase

Personal Data: various types of Data as specified in the privacy policy of the service (see [Firebase Privacy Statement](https://firebase.google.com/support/privacy))
...
## Not mandatory: third-party services

#### Google Analytics

Personal Data: we measure visitors to our website using [Google Analytics](http://www.google.com/analytics/learn/privacy.html)
...
Firebase is the hosting service provided by Google Inc. You may opt out of certain Firebase features, such as your device advertising settings or by following the instructions provided by Google in their Privacy Policy. We also encourage you to review Google’s policy for safeguarding your data. For more information on privacy and security in Firebase, please visit here.

[Firebase Privacy Statement](https://firebase.google.com/support/privacy/)
...
This records what pages you view within our site, how you arrived at our site and some basic information about your computer. All of that information is anonymous so we don't know who you are; just that somebody visited our site.
